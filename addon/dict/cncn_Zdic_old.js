...
class cncn_Zdic {
  ...
  async findZdic(word) {
    ...
    for (const img of doc.body.querySelectorAll("img")) {
      ...
      else img.setAttribute("src", "https://www.zdic.net" + src);
    }
